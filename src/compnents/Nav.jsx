...
const Nav = () => {
    return (
        <div>
            <div className="navbar shadow-lg px-4 fixed z-10 bg-base-100">
                <div className="flex-1">
                    <NavLink to="/" className="btn btn-ghost text-2xl text-secondary gap-0">Byte<span className="text-primary">Blaze</span></NavLink>
                </div>
